...
writeAComment(){
  this.setState({
    ...
    this.setState({
      ...
      ctx.setState({
        isLikedHeart: !ctx.state.isLikedHeart
      })
          ...
          <ModalBody style={cardText}>
            <Container>
              ...
              {this.state.seeMoreText ? (
                <CardText style={cardVilleMobile}>{this.props.activityResume}</CardText>
              ) : (
            ...
            <ModalFooter>
              {this.state.writeAComment? (
                <Button color="info" onClick={this.writeAComment.bind(this)}> Rédiger un commentaire</Button>
              ):(
                <div>
                  <Button color="primary" onClick={this.sendAComment.bind(this)}> Envoyer</Button>
                </div>)}
