              ...
              <div style={{display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', margin:'auto'}} >
                {this.state.isLoggedIn ? (
                  <div style={{marginBottom:100}}>
                    ...
                    {matches =>
                      matches ? (
                          <h1 style={{marginTop:100, marginBottom:80, textAlign:"center", fontSize:35}}>Partagez votre activité à la communauté !</h1>
                        ):(
                          <h1 style={{marginTop:100, marginBottom:80, textAlign:"center"}}>Partagez votre activité à la communauté !</h1>)}
                        </Media>
                        <Form style={{marginLeft:'auto', marginRight:'auto', marginTop:50, alignItems:'center', display:'flex', flexDirection:'column'}}>
                          ...
                          <div>
                            ...
                            <Link to="/">
                              <Button  color="secondary" className="btn btn-primary" style={{marginLeft:10}}>Retour</Button>
                            </Link>
                          </div>
                        </Form>
