...
class SeeActivities extends React.Component {
  constructor(props){
    super(props)
    this.state={
      activities:[],
  ...
  render() {
    ...
    const searchList = this.state.activities.filter((activities) =>{
      return activities.activityTheme.indexOf(this.state.searchTheme) !== -1 &&
      activities.activityDepartement.indexOf(this.state.searchDepartement) !== -1
    })
      ...
      <div>
        ...
        <Container>
          <div style={{marginBottom:100}}>
            ...
            {matches =>
              matches ? (
                <h1 style={{marginTop:100, marginBottom:80, textAlign:"center", fontSize:35}}>Partagez et participez !</h1>):(<h1 style={{marginTop:100, marginBottom:80, textAlign:"center"}}>Partagez et participez !</h1>)}
            </Media>
              <Row>
